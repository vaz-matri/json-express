...
The Swagger provider is auto-discovered by the `json-express` runtime. Installing it replaces the [`docs-light`](/docs-light) provider that ships with [`@json-express/boot`](/boot).
...
*   **[@json-express/api-rest](/api-rest):** The Swagger plugin documents the routes generated by this package.
*   **[@json-express/docs-light](/docs-light):** A highly optimized, blazing fast alternative to Swagger UI using modern lightweight web components.
